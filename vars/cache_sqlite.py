...
SELECT
    ...
    CASE ZRTCLLOCATIONMO.ZSPEED
        WHEN -1.0 THEN NULL
        ELSE ROUND(ZRTCLLOCATIONMO.ZSPEED, 6)
    END AS 'speed_meters_sec',

    CASE ZRTCLLOCATIONMO.ZSPEED
        WHEN -1.0 THEN NULL
        ELSE ROUND(ZRTCLLOCATIONMO.ZSPEED * 2.23694, 6)
    END AS 'speed_mph',
    ...
    ROUND(ZRTCLLOCATIONMO.ZHORIZONTALACCURACY, 6) AS 'horiz_accuracy_meters',
    ROUND(ZRTCLLOCATIONMO.ZHORIZONTALACCURACY * 3.281, 6) AS 'horiz_accuracy_feet',

    CASE ZRTCLLOCATIONMO.ZVERTICALACCURACY
        WHEN -1.0 THEN NULL
        ELSE ROUND(ZRTCLLOCATIONMO.ZVERTICALACCURACY, 6)
    END AS 'vertical_accuracy_meters',

    CASE ZRTCLLOCATIONMO.ZVERTICALACCURACY
        WHEN -1.0 THEN NULL
        ELSE ROUND(ZRTCLLOCATIONMO.ZVERTICALACCURACY * 3.281, 6)
